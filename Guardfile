group :nojasmine do
  ...
  guard 'rspec', cli: "--profile -b --color --fail-fast -r support/formatters/anxious_formatter.rb -f AnxiousFormatter", bundler: false, all_on_start: false, all_after_pass: false do
