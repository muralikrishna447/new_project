class UserProfilesController < ApplicationController
  ...
  def show
    ...
    @timeline_events =  @user.events.includes([:user]).limit(TIMELINE_EVENT_LIMIT).timeline.find_all { |e| e.trackable.published rescue true }.reject { |e| e.trackable_type == 'Vote'}
