class BloomController < ApplicationController
  ...
  def whats_for_dinner
    @feed = HTTParty.get('https://ancient-sea-7316.herokuapp.com/posts?apiKey=xchefsteps&categoryId=7fc5373b-ed4e-43bd-acdc-10591eb205a0&seen=&size=10&sort=new&sso=true')
    render json: @feed
  end
