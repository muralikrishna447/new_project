class HomeController < ApplicationController
  ...
  def about
    ...
    @team = [
      ...
      { name: 'Karen Quinn', title: '', image: 'https://d3awvtnmmsvyot.cloudfront.net/api/file/ivvAekO6QGGNo02FR9cA/convert?fit=max&w=400&h=400&cache=true', bio: 'Karen is a New England native, an English major, and a former magazine editor.' },
      { name: 'Cloud', title: '', image: 'https://d3awvtnmmsvyot.cloudfront.net/api/file/7X5Dnuk3TmTqvqWmkHQA/convert?fit=max&w=400&h=400&cache=true', bio: 'More obsessed with food than the rest of us.' }
    ]
