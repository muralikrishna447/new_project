class HomeController < ApplicationController
  ...
  def about
    ...
    @team = [
      ...
      { name: 'Nicholas Gavin', title: 'Development Chef', image: 'https://d3awvtnmmsvyot.cloudfront.net/api/file/fr5GtDkNQfuEr9ju3vVZ/convert?fit=crop&w=400&h=400&cache=true', bio: "Nick got his first restaurant job at age 17, washing dishes in Walla Walla, WA. He got thrown onto the line for the first time when a cook didn't show up for work. He quickly fell in love with the intensity and structure of the kitchen. After attending culinary school in Oregon, Nick took on a portfolio of challenges, cooking at Seattle fine dining staple Rover's, and later at Modernist Cuisine private events. He also worked on the development team for three months at the famed two-Michelin-starred restaurant Mugaritz, in Spain." },
      { name: 'A.L. Esterling', title: 'Director of Social Media', image: 'https://d3awvtnmmsvyot.cloudfront.net/api/file/rLXAD1pHSpKB8ShcV6jo/convert?fit=crop&w=400&h=400&cache=true', bio: "Lorraine's multi-faceted background includes a mid-70s conceptual art school education, a decade of restaurant work, and a twenty-year real-life Mad Men stint in advertising. She now works as our social media guru, TKTK. Other skills include expert toddler wrangling, nerdy cookbook perusal, and the ability to both create and spot typos instantly." },
