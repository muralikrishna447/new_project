class HomeController < ApplicationController
  ...
  def about
    ...
    @team = [
      ...
      { name: 'Tom Udd', image: 'http://placehold.it/400x400/&text=O_O', bio: "Coming soon."},
      ...
      { name: 'Mel Chang', image: 'http://placehold.it/400x400/&text=O_O', bio: 'Interning for the summer.'},
      { name: 'Marc Feifel', image: 'http://placehold.it/400x400/&text=O_O', bio: 'Coming soon.'},
