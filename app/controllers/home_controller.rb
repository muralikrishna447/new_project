class HomeController < ApplicationController
  ...
  def about
    ...
    @team = [
      ...
      { name: 'Tom Udd', image: 'https://d3awvtnmmsvyot.cloudfront.net/api/file/V4WLpsZzRfGmUoc2QEl4/convert?fit=max&w=300&h=300&cache=true', bio: "Coming soon."},
      ...
      { name: 'Mel Chang', image: 'http://placehold.it/400x400/&text=O_O', bio: 'Mel is an illustrator and designer who likes to make, look at, and eat pretty things. She came from Valve as an illustrator and graphic designer and currently studies industrial design at RISD. As a design intern at ChefSteps, she focuses on packaging design and branding.'},
      { name: 'Marc Feifel', image: 'https://d3awvtnmmsvyot.cloudfront.net/api/file/kuCx2KWOR5KjOLm4DweJ/convert?fit=max&w=300&h=300&cache=true', bio: 'Marc Feifel is a mad scientist genius best known for his name, Marc Feifel. He was born and raised in exotic Renton, Washington and is half-German and half-Kansan, and spends his time exploring Belltown, at times traveling the world, skiing the powder, and arguing the laws of physics. He prides himself on his generosity and is willing to do anything you ask. Except dishes. He also does engineering from time to time.'},
