class CopyController < ApplicationController
  ...
  [
    :thank_you_subscribing, :thank_you_intro, :thank_you_image_left, :thank_you_image_left_caption,
    :thank_you_image_middle, :thank_you_image_middle_caption, :thank_you_image_right,
    :thank_you_image_right_caption, :terms_of_service, :privacy_policy, :licensing, :jobs
  ].each do |key|
