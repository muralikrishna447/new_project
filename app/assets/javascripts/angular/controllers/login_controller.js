// angular.module('ChefStepsApp').controller( 'LoginController', function( $scope, $http ) {
...
//         if (status == 200){
//           $scope.login_message.message = parameters.success_message
//           console.dir($scope.login_message)
