...
class FreshStepsProxy < Rack::Proxy
  ...
  EXACT = %w(/ /classes /sous-vide /grilling /indoor-barbecue /thanksgiving /holiday /premium /password-reset /chefsteps-debuts-joule /joule /joule/ /joule/app /joule/hardware /joule/specs /joule/discussion)
