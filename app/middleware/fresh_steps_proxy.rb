...
class FreshStepsProxy < Rack::Proxy
  ...
  PREFIX = %w(/gallery /classes /logout /fs_pages /fs_activities /gift /admin/components /tpq /about /press /press-faq /joule /joule-overview /recommended /market /joule-split /orders)
