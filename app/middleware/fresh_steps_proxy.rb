...
class FreshStepsProxy < Rack::Proxy
  ...
  EXACT = %w(/ /classes /sous-vide /grilling /indoor-barbecue /thanksgiving /holiday /premium /password-reset /chefsteps-debuts-joule /jobs /gifting /sso /sign-up /steak-by-joule /gifs /404 /preorder-sweepstakes /preorder-sweepstakes-legal)
