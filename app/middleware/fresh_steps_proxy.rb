...
class FreshStepsProxy < Rack::Proxy
  ...
  EXACT = %w(/ /classes /sous-vide /grilling /indoor-barbecue /thanksgiving /holiday /premium /password-reset /chefsteps-debuts-joule /joule /joule/ /joule/specs /joule/discussion)
