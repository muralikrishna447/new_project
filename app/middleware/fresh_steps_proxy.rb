...
class FreshStepsProxy < Rack::Proxy
  ...
  EXACT = %w(/ /classes /sous-vide /grilling /indoor-barbecue /thanksgiving /premium /password-reset /chefsteps-debuts-joule /joule /joule/ /joule/specs /joule/discussion)
