...
describe AnalyticsParametizer do
  ...
  let(:utm_with_referrer){ {"utm_source" => 'test2', "utm_campaign" => 'campaign2', "referer" => 'http://google.com' } }
  ...
  describe "set_params" do
    ...
    it "shouldn't merge in referrer if chefsteps" do
      results = AnalyticsParametizer.set_params(utm_with_referrer, "http://chefsteps.com")
