...
describe AnalyticsParametizer do
  ...
  describe "set_params" do
    it "should merge in the referer" do
      ...
      JSON.parse(results)['referer'].should == 'http://google.com'
    end

    it "shouldn't merge in referer if chefsteps" do
      results = AnalyticsParametizer.set_params(utm_with_term, "http://chefsteps.com")
      JSON.parse(results).should_not include('referer')
    end
  end
end
