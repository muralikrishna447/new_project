describe Api::V0::PagesController do
  ...
  describe 'GET #index' do
    include Docs::V0::Pages::Index
    # GET /api/v0/pages
    it 'should get an index of components', :dox do
      get :index
  ...
  describe 'PUT #update' do
    ...
    context 'PUT /update', :dox do
      ...
      it 'should update a page with a new comonent_page association' do
        ...
        put :update, params: {id: @page.id, page: page}
        response.should be_success
        page = JSON.parse(response.body)
        page['title'].should eq('Sous Vide')
      ...
      describe 'Json Data' do
        ...
        it 'should create a page with components' do
          put :update, params: { id: @page.id, page: @data }, as: :json
          page = JSON.parse(response.body)
          response.should be_success
        ...
        it 'should check component meta key as camelcase' do
          ...
          put :update, params: { id: @page.id, page: @data.deep_transform_keys{ |key| key.to_s.underscore } }, as: :json
          page = JSON.parse(response.body)
          response.should be_success
        ...
        it 'should return 404 for pages not found by id' do
          put :update, params: {id: 122, page: @data }, as: :json
          response.should_not be_success
        end
