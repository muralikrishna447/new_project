...
describe Api::V0::MenusController do
  ...
  describe 'GET #list' do
    include Docs::V0::Menus::List
    context 'should only receive menus marked as not-logged-in for non logged in users', :dox do
      before :all do
        Rails.cache.clear()
      end
    ...
    context 'should only receive menus marked as free for non subscribed users', :dox do
    ...
    context 'should only receive menus marked as studio for studiopass users', :dox do
    ...
    context 'should only receive menus marked as premium for premium users', :dox do
    ...
    context 'should only receive the menus which are having at least having one permission', :dox do
    ...
    context 'should purge cache while create/updating any menu', :dox do
