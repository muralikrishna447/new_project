...
describe Api::V0::CookHistoryController do
  include Docs::V0::CookHistory::Api
  ...
  describe 'GET #index' do
    include Docs::V0::CookHistory::Index
    context "GET /cook_history", :dox do
  ...
  describe 'GET #find_by_guide' do
    include Docs::V0::CookHistory::FindByGuide
    context "GET /find_by_guide", :dox do
      before :each do
      ...
      it "should find 0 items" do
        get :find_by_guide,  params: {guide_id: 'nobody'}
        response.should be_success
        parsed = JSON.parse response.body
      ...
      it "should find 2 items" do
        get :find_by_guide,  params: {guide_id: 'guide1'}
        response.should be_success
        parsed = JSON.parse response.body
      ...
      it "should respect limit" do
        get :find_by_guide,  params: {guide_id: 'guide1', limit: 1}
        response.should be_success
        parsed = JSON.parse response.body
  ...
  describe 'POST #create' do
    include Docs::V0::CookHistory::Create
    context "POST /cook_history", :dox do
      it 'should create a Cook History Item that belongs to authenticated user' do
        post :create,  params: { cook_history: create_cook_entry() }
        response.should be_success
        parsed = JSON.parse response.body
      ...
      describe 'validation' do
        ...
        it 'should succeed when valid: guided and AUTOMATIC' do
          ...
          post :create,  params: { cook_history: create_params }
          response.should be_success
        end
  ...
  describe 'DELETE #destroy' do
    include Docs::V0::CookHistory::Destroy
    context "DELETE /cook_history", :dox do
      # DELETE /api/v0/cook_history
      it 'should delete a Cook History Item' do
        fabricate_unique_cook_history_item
        delete :destroy,  params: {id: @history_item.external_id}
        response.should be_success
      ...
      it 'should delete all entries with the same cook_id as the entry specified' do
        ...
        delete :destroy,  params: {id: duplicate_1.external_id}
