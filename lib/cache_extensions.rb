 module CacheExtensions
  class << self
    ...
    # honors expirations set earlier. I'm surprised Rails.cache.fetch
    ...
    # retry_expiration - how long between retries if the block raises an exception.
    #                    if expiration is long, you may want to make this shorter.
    # block            - should return the updated value, or raise an exception if it
    #                    can't be retrieved
    #
