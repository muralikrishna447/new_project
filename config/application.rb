...
module Delve
  class Application < Rails::Application
    ...
    config.middleware.insert_before ActionDispatch::Static, Rack::SslEnforcer, only: ['/charges', %r{/landing$}], only_environments: ['production', 'staging'], force_secure_cookies: false
  end
end
