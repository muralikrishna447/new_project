...
module Delve
  class Application < Rails::Application
    ...
    config.middleware.insert_before ActionDispatch::Static, Rack::SslEnforcer, only: [%r{/landing$}, %r{sign_in\.json}, %r{users\.json}], only_environments: ['production', 'staging'], force_secure_cookies: false
  end
end
